...
# Covid19 <- read.csv2("covid_data1.csv")
# 
# covid <- select(Covid19, 
#                 Country=location, 
#                 Region=region, 
#                 Week=week, 
...
ui<-navbarPage("Dashboard",
               tabPanel("Covid19",titlePanel("Cases"), 
                        sidebarLayout(
                          sidebarPanel(DT::dataTableOutput("table1"),
                                       downloadButton("downloadData", "Download Data", href = "https://github.com/jerrel-theos/Covid-19/blob/master/covid_data1.csv")),
               ...
               sidebarLayout(
                 sidebarPanel(
                   downloadButton("downloadCode", "Download Code", href = "https://github.com/jerrel-theos/Covid-19/blob/master/Covid-19.R")),
